...
/*
  ...
  if mentionedUserID is not empty, then this answer is another user's answer and called as "mention-answer" and is being listed in sub-answers.
  ...
  constraints:
    ...
    example:
      ...
      mentionedAnswerID != "" && mentionedUserID != "" => OK (mention-answer)
